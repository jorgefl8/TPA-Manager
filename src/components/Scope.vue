...
<template>
  ...
  <div class="flex flex-column gap-2">
    <mark v-if="isEditionMode" class="py-2 mr-3" style="width: fit-content;">
    ...
    <div class="flex gap-2">
      ...
      <Checkbox v-model="isMemberNeeded" :disabled="!isEditionMode" :binary="true" trueValue="*" falseValue="null" @change="tpaEditionStore.updateTpaField(fieldName + '.member.default', isMemberNeeded)" />
    </div>

    <div class="flex align-items-center gap-2">
      <span>Agreement validity start:</span>
      <Calendar v-model="validityInitial" :disabled="!isEditionMode" showIcon showTime :manualInput="false" />
    </div>
