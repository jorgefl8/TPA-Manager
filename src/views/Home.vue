        ...
        <div class="card flex flex-column align-items-center md:px-5 lg:px-7 py-5 mb-0">
            ...
            <div>
                ...
                <div v-if="isMobile" class="mb-3" style="display: grid; grid-template-rows: auto auto auto; grid-template-columns: auto auto; align-items: center; justify-content: center; gap: 0.5rem;">
                    <Button class="mr-3" label="Create" icon="pi pi-wrench" severity="success" @click="openSelectTpaDialog('creation')" />
                    <span>Create a new TPA</span>
                    <Button class="mr-3" label="Delete" icon="pi pi-trash" severity="danger" @click="openSelectTpaDialog('deletion')" />
                    <span>Delete an existing TPA</span>
                    <Button class="mr-3" label="Display" icon="pi pi-search" @click="openSelectTpaDialog('visualization')" />
                    <span>View an existing TPA</span>
                    <Button class="mr-3" label="Edit" icon="pi pi-pencil" severity="warning" @click="openSelectTpaDialog('edition')" />
